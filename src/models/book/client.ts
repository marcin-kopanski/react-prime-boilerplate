...
const BookRequests = {
  ...
  post: (url: string, body: Book) =>
    axiosInstance.post<Book>(url, body).then(responseBody),
  patch: (url: string, body: Book) =>
    axiosInstance.patch<Book>(url, body).then(responseBody),
